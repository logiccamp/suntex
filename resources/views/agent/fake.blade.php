                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control filter-input" placeholder="2 Bedroom flat at ...">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control filter-input" placeholder="Enter nearest bus-stop">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <label>Select Country</label>
                        <select disabled class="form-control form-select" id="country" name="country">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="Postal Code" class="form-control filter-input" placeholder="4000">
                        </div>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <label>Select Property Tag</label>
                        <select name="tag" id="tag" class="form-control form-select">
                            <option value="">Select</option>
                    ...
                    <div class="col-md-12">
                        <form>
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control" id="list_info" rows="4" placeholder="Enter your text here"></textarea>
                            </div>
                        </form>
                    </div>
                </div>
                            ...
                            <form class="photo-upload">
                                <div class="form-group">
                                    <div class="add-listing__input-file-box">
                                        <input class="add-listing__input-file" type="file" name="propertymainimage">
            ...
            <div class="db-add-listing">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <select name="floor" id="" class="form-control form-select">
                            <option value="" >Select</option>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input name="sqrmeter" type="text" class="form-control filter-input" placeholder="1240">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Size of Rooms in Sq Ft</label>
                            <input type="text" name="sqrmeterroom" class="form-control filter-input" placeholder="144">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Size of Bathroom in Sq Ft</label>
                ...
                <div class="row mb-30">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="noofrooms" id="noofrooms" class="form-control form-select">
                                <option value="">Select</option>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="filter-checkbox">
                                <input id="check-a" class="form-control form-check" type="checkbox" name="check">
