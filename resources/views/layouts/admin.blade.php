...
<body>
  ...
  <div id="app">
    <div class="main-wrapper main-wrapper-1">
      <div class="navbar-bg nav_bg" style="height: 15vh;"></div>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a class="nav-link" href="/management/admin/agents/blocked">Blocked</a></li>
                <li><a class="nav-link" href="/management/admin/agents/pending">Pending</a></li>
              </ul>
            </li>
