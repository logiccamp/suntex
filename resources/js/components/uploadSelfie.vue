    ...
    <div class="web-camera-container">
        <div class="camera-button text-center">
            <div class="card p-3 " v-if="!isCameraOpen">
                <img src="/assets/images/profileimage.jpg" class="img-fluid" />
                <h3>Confirm your identity</h3>
                <h5>Please upload a photo of yourself that clearly shows your face</h5>
            </div>
...
export default {
  ...
  methods: {
    ...
    var data = {'image':file}
    await axios.post(`/api/uploadselfie/${this.id}`, formdata, {
    headers:{
        ...
        .then((response)=>{
            ...
            if(response.data == true){
                alert("Profile uploaded successfully, click okay to continue")
                window.location.assign("/agent/profile/upload-id")
            }
        })
        .catch((error)=>{
            console.log(error)
