<template>
        <section id="searchforhouse" class="searchforhouse">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="form-group">
                        ...
                        <select @change="toggleLGA" name="state" id="state" class="form-control">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="form-group">
                        ...
                        <select name="lga" class="form-control">
                            ...
                            <option v-for="(item, index) in lga" :key="item" :value="item">{{item}}</option>
                        </select>
                    </div>
                </div>
...
<script>
    export default {
        methods: {
            toggleLGA(event){
                var thislga = event.target.value.replace(" ", "")
                this.lga = this.localGovts[thislga]
            }
        },
        mounted() {
