    ...
    <div class="web-camera-container">
        <div class="camera-button text-center">
            <div class="p-3" v-if="!isCameraOpen">
              <h3>Confirm your identity - step 3</h3>
              <h5>Confirm your identity with a photo of yourself holding your {{document}}</h5>
            </div>
            <div class="card p-3 " v-if="!isCameraOpen">
                <img src="/assets/images/selfieid.jpg" class="img-fluid" />
            </div>
  ...
  export default {
      ...
      methods: {
          ...
          async saveProceed() {
            ...
            var data = {'image':file}
            await axios.post(`/api/uploadselfieid/${this.id}`, formdata, {
            headers:{
            ...
            .then((response)=>{
                ...
                if(response.data == true){
                    alert(`Your account has been updated successfully, click okay to continue`)
